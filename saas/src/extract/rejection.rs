...
use saas_core::__composite_rejection as composite_rejection;
use saas_core::__define_rejection as define_rejection;

pub use crate::extract::path::{FailedToDeserializePathParams, InvalidUtf8InPathParam};
pub use saas_core::extract::rejection::*;
...
define_rejection! {
    ...
    /// Rejection type used if saas's internal representation of path parameters
